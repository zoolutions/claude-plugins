...
Every one of these has produced an accepted finding in at least two of: importmap-plus (JavaScript module inspection, pin lines), dash (Dockerfile analysis), pgbus (translation keys, SQL identifiers).
