...
If `lode/` already exists and the argument is `audit`, skip to step 5.
...
lode/
  ...
  plans/            link to docs/plans or the issue tracker; do not move existing plans
...
The body lists: the files created, the number of review rules imported and from which source, every doc-versus-code disagreement found, and the gate report.
