...
1. **Name the grammar it approximates.** What language is the input really in (JavaScript, a Dockerfile, a pin line, a URL, a package spec)? A regex over a real language is always an approximation; your job is to find where the approximation and the language disagree.
